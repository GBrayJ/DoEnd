...
export class SubtaskUpdateManyWithoutTaskNestedInput {
    ...
    set?: Array<Prisma.AtLeast<SubtaskWhereUniqueInput, 'id'>>;

    @Field(() => [SubtaskWhereUniqueInput], {nullable:true})
    @Type(() => SubtaskWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<SubtaskWhereUniqueInput, 'id'>>;

    @Field(() => [SubtaskWhereUniqueInput], {nullable:true})
    @Type(() => SubtaskWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<SubtaskWhereUniqueInput, 'id'>>;

    @Field(() => [SubtaskWhereUniqueInput], {nullable:true})
    @Type(() => SubtaskWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<SubtaskWhereUniqueInput, 'id'>>;
